...
- One-click login, no complicated registration process
- Secure and reliable OAuth 2.0 authorization mechanism
- Automatic acquisition of user repository access permissions
...
**Batch Processing**
- Support batch selection of documents that need translation
...
Compared with traditional translation solutions, GitHub Global does not require users to:
...
- Customize translation configuration
